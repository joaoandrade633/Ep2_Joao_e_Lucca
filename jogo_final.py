...
print(f"Olá! Você está no jogo dos seus alunos preferidos e terá a oportunidade de enriquecer!")

nome = input('Qual seu nome?')

print(f'\nOk {nome}, você tem direito a pular 3 vezes e 2 ajudas!')
print(f'opções de resposta são "A", "B", "C", "D", "ajuda", "pula" e "parar"!')
    ...
    while True:
        ...
        if resposta == "PARAR":
            ...
            if len(questoes_sorteadas) < len(QUESTOES):
                ...
                print("Voce ainda tem",pulos_disponiveis, 'pulo(s)')
                print('dinheiro atual:', dinheiro_atual)
            else:
        ...
        if dinheiro_atual >= 10000:
            print(f"Parabéns {nome}, você conseguiu ficar milionário !")
            break
